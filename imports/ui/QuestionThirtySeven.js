...
const AppQ = (values, handleChange, handleSubmit) => {
  return (<div className='wrapper'>
    <div className='questionList'>
      <p className='questionList__message'>37. Referring again to the same incident, what would you have preferred to do if you had a choice.</p>
    </div>
    ...
    <Form>
      ...
      <div className='question__spacing'>
        <label >
          <Field className='form__input' type='textarea' name='q_37_answer' placeholder='Other'/>
        </label>
      </div>
      <div>
...
const FormikApp = withFormik({
  ...
  handleSubmit(values) {
    ...
    if (values.q_37_answer) {
      browserHistory.push("/q38");
    }
