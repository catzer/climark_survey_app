...
const AppQ = (values, handleChange, handleSubmit) => {
  return (<div className='wrapper'>
    <div className='questionList'>
      <p className='questionList__message'>4. What is your sub-county?</p>
    </div>

    <Form>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='subcounty' value='Sakuu'/>
          Sakuu
        </label>
      </div>
      ...
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='subcounty' value='Laisamis'/>
          Laisamis
        </label>
      </div>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='subcounty' value='North Horr'/>
          North Horr
        </label>
      </div>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='subcounty' value='Moyale'/>
          Moyale
        </label>
      </div>
...
const FormikApp = withFormik({
  ...
  handleSubmit(values) {
    console.log('Selected sub-county is:' + values.subcounty);
    if (!!values.subcounty) {
      browserHistory.push("/q6");
    }
    ...
    Survey.update({
      ...
      $set: {
        Question_four: values.subcounty
      }
