...
const AppQ = (values, handleChange, handleSubmit) => {
  return (<div className='wrapper'>
    <div className='questionList'>
      <p className='questionList__message'>10. This is the number of people who live in my home:</p>
    </div>

    <Form>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='people_in_my_house' value='1'/>
          1
        </label>
      </div>
      ...
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='people_in_my_house' value='2'/>
          2
        </label>
      </div>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='people_in_my_house' value='3'/>
          3
        </label>
      </div>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='people_in_my_house' value='4'/>
          4
        </label>
      </div>
      <div className='question__spacing'>
        <label >
          <Field type='radio' name='people_in_my_house' value='5+'/>
          5+
        </label>
      </div>
...
const FormikApp = withFormik({
  ...
  handleSubmit(values) {
    console.log('I have lived in this ward for:' + values.people_in_my_house);
    if (!!values.people_in_my_house) {
      browserHistory.push("/q11");
    }
    ...
    Survey.update({
      ...
      $set: {
        Question_ten: values.people_in_my_house
      }
