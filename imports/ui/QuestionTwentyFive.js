...
export default class QuestionTwentyFive extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      survey: []
...
const AppQ = (values, handleChange, handleSubmit) => {
  return (<div className='wrapper'>
    <div className='questionList'>
      <p className='questionList__message'>25. Suppose a severe weather WATCH (Drought, Heat, flash flood, etc) was issued for your county/Ward, what action would you take?</p>
    </div>
